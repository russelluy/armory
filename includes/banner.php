...
<div class="flicker-example" data-block-text="false">
	...
	<ul>
		...
		<li data-background="<?php bloginfo('template_url'); ?>/images/slides/hero_drillCourt.jpg">
		...
		<li data-background="<?php bloginfo('template_url'); ?>/images/slides/hero_sciFi.jpg">
			<div class="flick-title"></div>
			<div class="flick-sub-text"></div>
		</li>

		<li data-background="<?php bloginfo('template_url'); ?>/images/slides/hero_speakeasy.jpg">
			<div class="flick-title"></div>
			<div class="flick-sub-text"></div>
		</li>
		<li data-background="<?php bloginfo('template_url'); ?>/images/slides/hero_diningRoom.jpg">
			<div class="flick-title"></div>
			<div class="flick-sub-text"></div>
		</li>
